...
class Add extends React.Component {
    constructor(){
      ...
      handleUploadPhoto = async() => {
        ...
        fetch("http://192.168.43.209:8500/api/children/add/1",{
            method:"POST",
...
class Main extends React.Component {
    ...
    async componentDidMount() {
        Axios.get('http://192.168.43.209:8500/api/children/1')
        .then(res=> {
    ...
    render() {
        ...
        return(
            <View style= {{flex:1}}>
              <Text style={{flex:1,color:'dodgerblue', fontSize:50, textAlign:'center',marginTop:50}}>Found Child</Text>
